function onCreate()
	-- background shit
	makeLuaSprite('spookyarena', 'spookyarena',-1000,-575);
	setScrollFactor('spookyarena', 1.0, 1.0);
	...
	if not lowQuality then
		precacheImage("characters/Himspookyarena")
	...
	addLuaSprite('spookyarena', false);
